    ...
    if event in (sg.WINDOW_CLOSED, "Cancel"):
        ...
        if '' not in [file_1]:
            ...
            for i in range(2,row+1):
                ...
                document=Document('E:\\Invoice_Generator\\input'+'\\sample_invoice.docx')
                ...
                for table in document.tables:
                    for row in table.rows:
                        for cell in row.cells:
                            ...
                            document.save('E:\\Invoice_Generator\\output'+"\\"+recipient_name+'.docx')
            ...
            print("Please find invoices in path: ")
