...
print("hello")
inputpath=input("Please provide your directory path of your input_excel file...")
wb=openpyxl.load_workbook(inputpath+'\\input_excel.xlsx')

outputpath=input("Please provide output path for invoice to download...")
    ...
    for table in document.tables:
        for row in table.rows:
            for cell in row.cells:
                ...
                document.save(outputpath+"\\"+recipient_name+'.docx')

print("Generating pdf formatted invoices. Please wait......")

convert(outputpath+'\\')
want_word=input("Do you want word formatted invoices deleted? Y/N")
